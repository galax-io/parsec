...
| Fact | Value |
|---|---|
| Gatling version (from the RUN record) | 3.15.1 |
| Build | `sbt -Dgatling.version=3.15.1 "Gatling/testOnly io.galaxio.parsec.corpus.CorpusSimulation"` |
