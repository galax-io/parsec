...
- [X] T046 [US5] Add `TestPeakMemoryAtTheStringCeiling` to `gatling/binary/memory_test.go` asserting the 32 MiB budget over that log. It MUST fail against today's 8 MiB ceiling — measured 52.3 MiB — which is the whole point of the task order.
