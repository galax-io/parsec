...
```bash
go test ./gatling/text/ -run TestGolden -update
```
...
and by hand from the Actions tab with any version list. Locally:
...
- [ ] Issue #3's acceptance criterion corrected to match the fail-fast decision
